...
CREATE INDEX IF NOT EXISTS "er_cases_er_year_idx" ON "english_reports"."cases" ("er_year");

CREATE INDEX IF NOT EXISTS "er_cases_er_cite_idx" ON "english_reports"."cases" ("er_cite");

CREATE INDEX IF NOT EXISTS "er_cases_er_parallel_cite_idx" ON "english_reports"."cases" ("er_parallel_cite");
